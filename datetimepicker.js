...
(function (factory) {
  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    .constant('dateTimePickerConfig', {
      ...
      modelType: 'Date',
      dropDownTZ: 'LOCAL',
      modelTZ: 'UTC', // modelTZ = UTC or LOCAL
        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            ...
            setTime: function setTime(milliseconds) {
              ...
              console.log ("incoming milliseconds: "+ milliseconds);
			  ...
			  //console.log ("configuration.modelType: "+ configuration.modelType);
              switch (configuration.modelType) {              	
                ...
                case 'milliseconds':
                	...
                	newDate.local();
                  	...
                  	//console.log ("Milliseconds NewDate: "+ newDate);
                  break;
                default: // It is assumed that the modelType is a formatting string.
                	if (configuration.modelTZ == 'UTC') {
		                  newDate = moment.utc(newDate).format(configuration.modelType); // AT                		
                	}
     	            else  {
     	              	newDate = moment(newDate);
     	              	newDate.local();
                	...
                	//console.log ("Default newDate: " + newDate);
              }
...
//				console.log ("getUTCTime: " + getUTCTime(ngModelController.$modelValue));
				scope.changeView(configuration.startView, new DateObject({utcDateValue: getUTCTime(ngModelController.$viewValue)}));
				//scope.changeView(configuration.startView, new DateObject({utcDateValue: getUTCTime(ngModelController.$modelValue)}));
